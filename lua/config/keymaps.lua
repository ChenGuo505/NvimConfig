...
vim.keymap.set("n", "<A-h>", "<CMD>BufferPrevious<CR>", { desc = "[Buffer] BufferPrevious" })
vim.keymap.set("n", "<A-l>", "<CMD>BufferNext<CR>", { desc = "[Buffer] BufferNext" })
vim.keymap.set("n", "<A-1>", "<CMD>BufferGoto 1<CR>", { desc = "[Buffer] BufferGoto 1" })
vim.keymap.set("n", "<A-2>", "<CMD>BufferGoto 2<CR>", { desc = "[Buffer] BufferGoto 2" })
vim.keymap.set("n", "<A-3>", "<CMD>BufferGoto 3<CR>", { desc = "[Buffer] BufferGoto 3" })
vim.keymap.set("n", "<A-4>", "<CMD>BufferGoto 4<CR>", { desc = "[Buffer] BufferGoto 4" })
vim.keymap.set("n", "<A-5>", "<CMD>BufferGoto 5<CR>", { desc = "[Buffer] BufferGoto 5" })
vim.keymap.set("n", "<A-6>", "<CMD>BufferGoto 6<CR>", { desc = "[Buffer] BufferGoto 6" })
vim.keymap.set("n", "<A-7>", "<CMD>BufferGoto 7<CR>", { desc = "[Buffer] BufferGoto 7" })
